...
class PlayerStatsFixtures extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $stat0->setUser($this->getReference('user-0'));
        ...
        $stat1->setUser($this->getReference('user-1'));
        ...
        $stat2->setUser($this->getReference('user-2'));
        ...
        $stat3->setUser($this->getReference('user-3'));
